...
So far, we've covered how to transform and shape data to get it into tidy, usable shape and merge with other data. So far, however, we've been working with standard data forms such as numeric variables and categorical text variables. Oftentimes, however, we'll encounter more tricky or complex data forms. This portion of the workshop covers how to deal with two of the most common of these: text data and dates. The tools for cleaning and working with this data that we'll use come from two main packages: **stringr**, for text data, and **lubridate**, for dates.  
...
Let's begin by loading the **tidyverse** package and the dataset itself. Now we're ready to get started.
