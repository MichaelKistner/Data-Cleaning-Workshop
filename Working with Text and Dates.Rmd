...
house_tweets %>%
  ...
  str_extract("[0-9][0-9]") 
```
As before, there's more that can be done with the **stringr** package, and I encourage you to look both at the cheatsheet as well as the relevant chapter of "Data Science with R"
